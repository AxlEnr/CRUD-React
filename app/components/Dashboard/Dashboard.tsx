...
function Dashboard() {
  ...
  return (
    <aside 
      className="shadow-lg dash-container md:h-screen md:w-16 hover:md:w-64 transition-all duration-300 ease-in-out md:fixed bg-white group"
    ...
    >
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex justify-between items-center py-4 md:block">
          <h2 className={`text-2xl font-bold nb-name mb-6 md:mb-12 hidden md:block group-hover:md:block whitespace-nowrap overflow-hidden ${isOpen ? 'text-white' : 'text-transparent'}`}>
            Panel de Control
          </h2>
          ...
          <ul className="space-y-4">
            <li>
              <a href="#" className="flex py-2 px-3 navbar-href group-hover:px-3 w">
                <svg viewBox="0 0 24 24" className={`transition-all duration-200 ${isOpen ? 'w-10' : 'w-100'}`} fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="ml-0.5 sizeFont hidden group-hover:inline whitespace-nowrap">Usuarios</span>
              </a>
            </li>
            <li>
              <a href="#" className="flex py-2 px-3 navbar-href group-hover:px-3">
                <svg className={`transition-all duration-200 ${isOpen ? 'w-10' : ''}`} fill="#fff" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 492.005 492.006">
                ...
                <span className="ml-0.5 sizeFont hidden group-hover:inline whitespace-nowrap">Productos</span>
              </a>
            </li>
            <li>
              <a href="#" className="flex py-2 px-3 navbar-href group-hover:px-3">
                <svg viewBox="0 0 1024 1024" fill="#fff" className={isOpen ? 'dash-svg' : 'dash-svg-normal'}>
